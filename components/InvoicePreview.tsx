...
export const InvoicePreview: React.FC<InvoicePreviewProps> = ({ order, settings }) => {
  ...
  return (
      <div className="invoice-sheet w-full max-w-[21cm] mx-auto bg-white text-gray-900 shadow-lg">
        <div className={`flex flex-col ${getFontClass(settings.fontFamily)}`}>
            {/* Decorative Header */}
            <div className={`h-2.5 ${themeStyles.primaryBg} flex-shrink-0`}></div>
            
            {/* Main Content */}
            <main className="p-8 sm:p-12 flex-grow">
